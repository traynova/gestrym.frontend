...
SERVICE_NAME="gestrym-frontend"
IMAGE_BASE="jhonnier/front-web"
...
# Auto-ajustar versión en stack.env
set_env_var() {
    local key="$1"
    local value="$2"
...
set_env_var "FRONTEND_IMAGE" "${IMAGE_BASE}:${VERSION}"

# Asegurar red compartida externa
